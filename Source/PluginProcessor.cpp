...
#endif
{
  oscillator_.initialise([](float p) { return std::sin(p); });
...
//==============================================================================
const juce::String BusyBoxAudioProcessor::getName() const { return JucePlugin_Name; }
...
double BusyBoxAudioProcessor::getTailLengthSeconds() const { return 0.0; }
...
int BusyBoxAudioProcessor::getCurrentProgram() { return 0; }

void BusyBoxAudioProcessor::setCurrentProgram(int index) {}

const juce::String BusyBoxAudioProcessor::getProgramName(int index) { return {}; }

void BusyBoxAudioProcessor::changeProgramName(int index, juce::String const& newName) {}
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool BusyBoxAudioProcessor::isBusesLayoutSupported(BusesLayout const& layouts) const {
#if JucePlugin_IsMidiEffect
...
void BusyBoxAudioProcessor::processBlock(juce::AudioBuffer<float>& buffer,
  ...
  while ((juce::Time::getMillisecondCounterHiRes() - begin) / 1000.0 < max) counter++;
}
...
void BusyBoxAudioProcessor::setStateInformation(void const* data, int sizeInBytes) {
...
juce::AudioProcessor* JUCE_CALLTYPE createPluginFilter() { return new BusyBoxAudioProcessor(); }
